    ...
    return(
        <div className='flex justify-content-center'>
            ...
            <form onSubmit={speakerForm.handleSubmit}>
                <div className='field'> 
                    <InputText id='name' name='name' value={speakerForm.values.name} 
                    onChange={speakerForm.handleChange} />
                </div>
                <div className='field'> 
                    <InputText id='bio' name='bio' value={speakerForm.values.bio} 
                    onChange={speakerForm.handleChange} />
                </div>
                <div className='field'> 
                    <InputText id='webSite' name='webSite' value={speakerForm.values.webSite} 
                    onChange={speakerForm.handleChange} />
                </div>
